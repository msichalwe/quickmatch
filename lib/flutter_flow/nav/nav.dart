...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => ChatPage5MinWidget(
            chatRef: params.getParam('chatRef', ParamType.Document),
          ),
        ),
        FFRoute(
          name: 'chatPageReview',
          path: '/chatPageReview',
          builder: (context, params) => const ChatPageReviewWidget(),
        ),
        FFRoute(
          name: 'answer',
          path: '/answer',
          builder: (context, params) => AnswerWidget(
            chat: params.getParam(
                'chat', ParamType.DocumentReference, false, ['searchingChats']),
          ),
        )
