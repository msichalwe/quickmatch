...
import 'chat_page5_min_model.dart';
export 'chat_page5_min_model.dart';

class ChatPage5MinWidget extends StatefulWidget {
  const ChatPage5MinWidget({
    super.key,
  ...
  @override
  State<ChatPage5MinWidget> createState() => _ChatPage5MinWidgetState();
}

class _ChatPage5MinWidgetState extends State<ChatPage5MinWidget> {
  late ChatPage5MinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatPage5MinModel());
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: Align(
          ...
          child: Padding(
            padding: const EdgeInsetsDirectional.fromSTEB(30.0, 140.0, 10.0, 0.0),
            child: FloatingActionButton.extended(
              onPressed: () async {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      '${_model.timerValue} Time Left till chat closses forever',
                      style: TextStyle(
